...
SECRET_KEY = 'fev=7*69g9d2%sli^9p7n$07m9$&ce_9%jeudpds(6)ktt+%z*'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, 'project', 'site_templates')
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
TIME_ZONE = 'UTC'
PROJECT_TIME_CLI_TIMEZONE = os.environ.get(
    "PROJECT_TIME_CLI_TIMEZONE",
    TIME_ZONE
)
