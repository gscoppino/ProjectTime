...
class CLITest(TestCase):
    ...
    def test_lists_active_projects(self):
        validate_and_save(Project(name="Test Active Project", active=True))
        validate_and_save(Project(name="Test Inactive Project", active=False))
    ...
    def test_renames_project(self):
        validate_and_save(Project(name="Test Project"))
    ...
    def test_sets_project_active(self):
        ...
        validate_and_save(Project(name="Test", active=False))
    ...
    def test_sets_project_inactive(self):
        self.assertEqual(Project.objects.count(), 0)
        validate_and_save(Project(name="Test", active=True))
        self.assertEqual(Project.objects.count(), 1)
        self.assertTrue(Project.objects.first().active)
    ...
    def test_commits_end_time_to_latest_open_charge(self):
        ...
        older_open_charge = validate_and_save(Charge(
            project=project,
            start_time=now
        ))
        ...
        newer_open_charge = validate_and_save(Charge(
            project=project,
            start_time=now
        ))
        ...
        newest_closed_charge = validate_and_save(Charge(
            project=project,
            start_time=now,
